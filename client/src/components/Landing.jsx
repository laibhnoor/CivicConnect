  ...
  return (
    <div className="cc-shell">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center cc-reveal">
          ...
          <Link
            to="/register"
            className="cc-btn-primary px-8 py-3 text-lg"
          >
            Start Reporting
          </Link>
        </div>
      ...
      {/* Features Section */}
      <section className="bg-gray-50/80 py-20 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-3xl font-bold text-gray-900 text-center mb-12">How It Works</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="cc-surface cc-surface-hover text-center p-8">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="cc-surface cc-surface-hover p-6 text-center">
      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-4 sm:space-y-0 sm:space-x-4">
            <Link
              to="/register"
              className="cc-btn bg-white text-gray-900 px-8 py-3 font-semibold hover:bg-gray-100"
            >
              Create Account
            </Link>
            <Link
              to="/login"
              className="cc-btn border-2 border-white text-white px-8 py-3 hover:bg-white hover:text-gray-900"
            >
              Sign In
            </Link>
          </div>
